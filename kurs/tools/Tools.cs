...
public class Tools
{
    ...
    public static String RandomSchet()
    {
        return $"{random.Next(0, 9)}{random.Next(0, 9)}{random.Next(0, 9)}-{random.Next(0, 9)}{random.Next(0, 9)}{random.Next(0, 9)}{random.Next(0, 9)}{random.Next(0, 9)}{random.Next(0, 9)}{random.Next(0, 9)}";
    }
} 
